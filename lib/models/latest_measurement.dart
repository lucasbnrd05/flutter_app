...
class LatestMeasurementResult {
  ...
  static LatestMeasurementResult? fromJson(Map<String, dynamic> json,
    ...
    if (json['coordinates'] != null && json['coordinates'] is Map) {
      ...
      final latNum = coordMap['latitude'];
      final lonNum = coordMap['longitude'];
      if (latNum is num &&
          lonNum is num &&
    ...
    if (json['datetime'] != null &&
        json['datetime'] is Map &&
        json['datetime']['utc'] is String) {
      dt = DateTime.tryParse(json['datetime']['utc'])?.toUtc() ?? dt;
    } else if (json['date'] != null &&
        json['date'] is Map &&
        json['date']['utc'] is String) {
      dt = DateTime.tryParse(json['date']['utc'])?.toUtc() ?? dt;
    } else {
      print(
          "[WARN LatestMeasurementResult] Missing or invalid date field ('datetime.utc' or 'date.utc'): ${json['datetime'] ?? json['date']}");
    }
...
const Map<int, Map<String, String>> PARAMETER_ID_TO_INFO = {
  ...
  8: {
    'name': 'co',
    'unit': 'ppm',
    'description': 'Carbon Monoxide (volume): Volume concentration. Toxic gas.'
  },
  9: {
    'name': 'so2',
    'unit': 'ppm',
  ...
  10: {
    'name': 'o3',
    'unit': 'ppm',
    'description': 'Ozone (volume): Volume concentration. Component of smog.'
  },
  11: {
    'name': 'bc',
    'unit': 'µg/m³',
    'description': 'Black Carbon: Soot from combustion, component of PM2.5.'
  },
  19: {
    'name': 'pm1',
    'unit': 'µg/m³',
  ...
  35: {
    'name': 'no',
    'unit': 'ppm',
    'description': 'Nitrogen Monoxide (volume): Precursor to NO2 and ozone.'
  },
  98: {
    'name': 'relativehumidity',
    'unit': '%',
    'description': 'Relative Humidity: Amount of water vapor in the air.'
  },
  100: {
    'name': 'temperature',
    'unit': '°C',
  ...
  19840: {
    'name': 'nox',
    'unit': 'ppm',
    'description': 'Nitrogen Oxides (volume): Combined NO and NO2.'
  },
  19843: {
    'name': 'no',
    'unit': 'µg/m³',
